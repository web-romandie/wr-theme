    ...
    if (have_comments()) :
        ...
        <h2 id="comments-title">
            ...
            if ('1' === $comments_number) {
                printf(_x('One Reply to &ldquo;%s&rdquo;', 'comments title', 'wr-theme'), get_the_title());
            } else {
                printf(
        ...
        if (get_comment_pages_count() > 1 && get_option('page_comments')) :
            ...
            <nav id="comment-nav-above">
                <h1 class="assistive-text"><?php esc_html_e('Comment navigation', 'wr-theme'); ?></h1>
        ...
        <ol class="commentlist">
             ...
             */
            wp_list_comments(array('callback' => 'wr_theme_comment'));
            ?>
        </ol>
        <?php
        if (get_comment_pages_count() > 1 && get_option('page_comments')) :
