    ...
    <div class="author-info<?php if (!is_single()) :
        ...
        <div class="row">
            <div class="col-sm-12">
                <h2>
                    <?php
                    echo get_avatar(get_the_author_meta('user_email'), apply_filters('wr_theme_author_bio_avatar_size', 48)) . '&nbsp;';
                    printf(esc_html__('About %s', 'wr-theme'), get_the_author());
                    ?>
                </h2>
                ...
                <div class="author-links">
                    ...
                    if (!empty(get_the_author_meta('user_url'))) :
                        printf('<a href="%s" class="www btn btn-secondary btn-sm">' . esc_html__('Website', 'wr-theme') . '</a>', esc_url(get_the_author_meta('user_url')));
                    endif;
